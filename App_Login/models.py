...
# To Create a Customer User Model and Admin Panel
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_active = models.BooleanField(
        ...
        default=True,
        help_text=ugettext_lazy('Designates whether this should be treayed as active. Unselect this instead of deleting accounts')
    )
